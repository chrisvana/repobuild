...
ifeq ($(CC_GCC),1)
	...
	CFLAGS= -stdlib=libc++ -pthread -g -Wall -Werror -Wno-sign-compare -O3 -Wno-unknown-warning-option
endif
ifeq ($(CXX_GCC),1)
	...
	CXXFLAGS= -stdlib=libc++ -pthread -g -Wall -Werror -Wno-sign-compare -O3 -Wno-unknown-warning-option -std=c++11 -DUSE_CXX0X
endif
